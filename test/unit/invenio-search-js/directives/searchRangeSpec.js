...
describe('Check search range factory', function () {
  ...
  var tip = d3.tip();
  var showSpy = sinon.spy(tip, 'show');
  var hideSpy = sinon.spy(tip, 'hide');
  sinon.stub(d3, 'tip').returns(tip);
  ...
  it('should show and hide the tip', function () {
    ...
    expect(hideSpy.calledAfter(showSpy)).to.be.true;
  });
